...
<script lang="ts">
    const { id, name, date, image, email, gender, purchases, spend, verified, mobileNumber }: ICustomerTableRow =
        $props();
</script>
    ...
    <td>
        <div class="inline-flex w-fit">
            ...
            <button
                ...
                onclick={() => document.querySelector<HTMLDialogElement>("#apps-customer-delete")?.showModal()}>
