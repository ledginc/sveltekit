<div>
            ...
            <div class="card-body">
                ...
                <div class="fieldset mt-2 grid grid-cols-1 gap-4 lg:grid-cols-2">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" class="input w-full" id="city" placeholder="City" value="Anchorage" />
                    </div>
                    <div class="space-y-2">
                        <label class="fieldset-label" for="state"> State </label>
                        <input type="text" class="input w-full" id="state" placeholder="State" value="Alaska" />
                    </div>
                    <div class="space-y-2">
                    ...
                    <div class="flex items-center gap-3">
                        <input class="checkbox checkbox-sm" type="checkbox" id="set-as-active" defaultChecked />
    ...
    <div class="mt-6 flex justify-end gap-3">
        <a class="btn btn-sm btn-ghost" href="/apps/ecommerce/shops">
            <span class="iconify lucide--x size-4"></span>
            Cancel
        </a>
        <a class="btn btn-sm btn-primary" href="/apps/ecommerce/shops">
