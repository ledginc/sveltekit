<script lang="ts">
    import CustomerDealTableRow, { type ICustomerDealTableRow } from "./CustomerDealTableRow.svelte";
    ...
    <div class="card-body p-0">
        ...
        <div class="mt-1 overflow-auto">
            <table class="table *:text-nowrap">
                ...
                <tbody>
                    {#each customerDealItems as recentOrder, index (index)}
                        <CustomerDealTableRow {...recentOrder} />
                    {/each}
                </tbody>
            </table>
        </div>
