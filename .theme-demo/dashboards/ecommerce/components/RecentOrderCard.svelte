<script lang="ts">
    import RecentOrderTableRow, { type IRecentOrderTableRow } from "./RecentOrderTableRow.svelte";
...
<div aria-label="Card" class="card bg-base-100 shadow">
    <div class="card-body p-0">
        <div class="flex items-center gap-3 px-5 pt-5">
            <span class="iconify lucide--shopping-bag size-4.5" />
        ...
        <div class="mt-2 overflow-auto">
            <table class="table *:text-nowrap">
                <thead>
                    <tr>
                        <th>
                            <input aria-label="checked-all-order" type="checkbox" class="checkbox checkbox-sm" />
                        </th>
                        <th>Product</th>
                        <th>Price</th>
                        <th>Date</th>
                ...
                <tbody>
                    {#each recentOrders as recentOrder, index (index)}
                        <RecentOrderTableRow {...recentOrder} />
                    {/each}
                </tbody>
            </table>
        </div>
